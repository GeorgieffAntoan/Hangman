...
public class GvrPointerInputModuleImpl {
  ...
  private void HandleDrag() {
    ...
    float angle = Vector3.Angle(pointer.PointerTransform.forward, _PressPose);
    bool shouldStartDrag = angle > 1.3f;
  ...
  private void HandleTriggerDown() {
    ...
    _PressPose = pointer.PointerTransform.forward;
  ...
  {
      if (pointer.raycastMode == GvrBasePointer.RaycastMode.Mouse)
          return true;
